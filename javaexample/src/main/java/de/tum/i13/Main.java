...
public class Main {
        ...
        public static void main(String[] args) {
                ...
                var challengeClient = ChallengerGrpc.newBlockingStub(channel) // for demo, we show
                                                                              // the blocking stub
                ...
                BenchmarkConfiguration bc = BenchmarkConfiguration.newBuilder()
                                ...
                                .setToken("dnkxzxwhdjfjqikllucypcylobndqhkk") // go to:
                ...
                while (true) {
                        ...
                        ResultQ1 q1Result =
                                        ResultQ1.newBuilder().setBenchmarkId(newBenchmark.getId()) // set
                                                                                                   // the
                                                                                                   // benchmark
                                                                                                   // id
                                                        .setBatchSeqId(batch.getSeqId()) // set the
                                                                                         // sequence
                                                                                         // number
                        ...
                        ResultQ2 q2Result = ResultQ2.newBuilder()
                                        .setBenchmarkId(newBenchmark.getId()) // set the benchmark
                                                                              // id
                                        .setBatchSeqId(batch.getSeqId()) // set the sequence number
                                        .addAllCrossoverEvents(crossOverevents).build();

                        challengeClient.resultQ2(q2Result);
                        System.out.println("Processed batch #" + cnt + " with size = "
