...
public class BatchedCollector {
    ...
    private final int[] vaultValues = { 
        1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013,
        1014, 1015, 1016, 1017, 1018, 1019, 1020, 1021, 1022, 1023, 1024, 1025, 1026, 1027,
        1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 1037, 1038, 1039, 1040, 1041,
        1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055,
        1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069,
        1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1084,
        ...
        1169, 1170, 1176, 1400, 1401, 1402, 1403, 1406, 1407, 1408, 1409, 2000, 2001, 2002,
        2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016,
        2017, 2018, 2019, 2020, 2021, 3000, 3001, 3002, 300 
    };
    ...
    public boolean collectState(DriveState.Builder state, HashSet<String> models) throws RocksDBException {
        if (currentBatchSize >= maxBatchSize) {
            ...
            random.ints(vaultValues.length, 0, vaultValues.length).distinct().limit(5).forEach(i -> bb.addVaultIds(vaultValues[i]));
