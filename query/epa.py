...
class EPATableP2(object):
    ...
    def __init__(self):
        ...
        self.table.append(EPAEntry(250.4, 150.5, 300.0, 201.0, "very unhealthy"))
...
class EPATableP1(object):
    ...
    def __init__(self):
        ...
        self.table.append(EPAEntry(254.0, 155.0, 150.0, 101.0, "unhealthy for sensitive groups"))
        self.table.append(EPAEntry(354.0, 255.0, 200.0, 151.0, "unhealthy"))
        self.table.append(EPAEntry(424.0, 355.0, 300.0, 201.0, "very unhealthy"))
